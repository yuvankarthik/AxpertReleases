...
public class TStructDef
{
                ...
                if (!fld.visibility)
                {
                    ...
                    if (isGrid)
                    {
                        ...
                        if (fld.tooltip != null && fld.tooltip != "")
                            ddetails = "<span class=\"material-icons material-icons-style align-middle material-icons-3 cursor-pointer\" title=\"Click on any row in this column to know more about the data in the cell.\">info</span>";
                    ...
                    else
                    {
                        if (fld.ctype.ToUpper() != "CHECK BOX")
                        {
                            ...
                            if (fld.tooltip != null && fld.tooltip != "")
                            {
                                fieldHtml.Append("<span class=\"material-icons material-icons-style ms-1 align-middle material-icons-3 cursor-pointer\" title=\"Display details\">info</span>");
                            }
    ...
    private string GetInputHTML(FieldStruct fld, bool isGrid, string name, int fldNo, string[] fldTlhw, string width, string NumericCss, string popImg, string popHdnImg)
    {
        ...
        if (fld.pwdchar != "")
            inputHTML.Append("<span class=\"input-group-text\"><i toggle=#" + name + " class=\"material-icons cursor-pointer fs-4 toggle-password\">visibility</i></span>");
    ...
    private string GetGridAttachHTML(FieldStruct Fld, bool IsGrid, string Name, int fldNo, string[] fldTlhw, string width)
    {
        ...
        if (IsGrid)
        {
            ...
            {
                if (!Name.ToLower().StartsWith("axpfile_"))
                    grdAttHTML.Append("<div class=\"form-group form-control p-0 grdattch\" id=\"" + divId + "\"><div id=\"dropzone_" + Name + "\" name=\"" + Name + "\" class=\"dropzone dropzone-queue min-h-1px border-0 px-3 py-2 dropzoneGrid\"><div class=\"d-flex flex-row-auto dropzone-panel mb-lg-0 m-0\"><a id=\"" + Name + "\" class=\"dropzone-select fs-7 text-truncate me-1 gridattach\"><span class=\"material-icons material-icons-style material-icons-2 float-start mx-2\">upload_file</span> Drop files here or click to upload</a><span class=\"material-icons material-icons-style material-icons-2 ms-auto pe-7 fileuploadmore d-none\" data-bs-toggle=\"popover\" data-bs-sanitize=\"false\" data-bs-placement=\"bottom\" data-bs-html=\"true\">more</span><div class=\"position-relative ms-0 mt-n1 d-none\" id=\"gridAttachCounter\"><span class=\"text-gray-600 spanAttCount fs-5 border border-1 border-gray-300 badge bg-white py-0 px-1 shadow-sm mt-1\"></span><span class=\"bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-75 animation-blink\"></span></div><a class=\"dropzone-remove-all btn btn-sm btn-light-primary d-none\">Remove All</a></div><div class=\"dropzone-items wm-200px d-none\"><div class=\"dropzone-item\" style=\"display: none\"><div class=\"dropzone-file overflow-hidden\"><div class=\"dropzone-filename\" title=\"some_image_file_name.jpg\"><span data-dz-name>some_image_file_name.jpg</span></div><div class=\"dropzone-error\" data-dz-errormessage></div></div><div class=\"dropzone-progress d-none\"><div class=\"progress\"><div class=\"progress-bar bg-primary\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" aria-valuenow=\"0\" data-dz-uploadprogress></div></div></div><div class=\"dropzone-toolbar\"><span class=\"dropzone-delete\" data-dz-remove><span class=\"material-icons material-icons-style material-icons-2 float-end\">clear</span></span></div></div></div></div></div>");
                else
                {
                    grdAttHTML.Append("<div class=\"form-group form-control p-0 grdattch\" id=\"" + divAxpFileId + "\"><div id=\"dropzone_" + Name + "\" name=\"" + Name + "\" class=\"dropzone dropzone-queue min-h-1px border-0 px-3 py-2\"><div class=\"d-flex flex-row-auto dropzone-panel mb-lg-0 m-0\"><a id=\"" + Name + "\" class=\"dropzone-select fs-7 text-truncate me-1 gridattach\"><span class=\"material-icons material-icons-style material-icons-2 float-start mx-2\">upload_file</span> Drop files here or click to upload</a><span class=\"material-icons material-icons-style material-icons-2 ms-auto pe-7 fileuploadmore d-none\" data-bs-toggle=\"popover\" data-bs-sanitize=\"false\" data-bs-placement=\"bottom\" data-bs-html=\"true\">more</span><div class=\"position-relative ms-0 mt-n1 d-none\" id=\"gridAttachCounter\"><span class=\"text-gray-600 spanAttCount fs-5 border border-1 border-gray-300 badge bg-white py-0 px-1 shadow-sm mt-1\"></span><span class=\"bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-75 animation-blink\"></span></div><a class=\"dropzone-remove-all btn btn-sm btn-light-primary d-none\">Remove All</a></div><div class=\"dropzone-items wm-200px d-none\"><div class=\"dropzone-item\" style=\"display: none\"><div class=\"dropzone-file overflow-hidden\"><div class=\"dropzone-filename\" title=\"some_image_file_name.jpg\"><span data-dz-name>some_image_file_name.jpg</span></div><div class=\"dropzone-error\" data-dz-errormessage></div></div><div class=\"dropzone-progress d-none\"><div class=\"progress\"><div class=\"progress-bar bg-primary\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" aria-valuenow=\"0\" data-dz-uploadprogress></div></div></div><div class=\"dropzone-toolbar\"><span class=\"dropzone-delete\" data-dz-remove><span class=\"material-icons material-icons-style material-icons-2 float-end\">clear</span></span></div></div></div></div></div>");
                }
            }
        ...
        if (fldRange.Length > 1)
        {
            ...
            for (int i = startIndex; i <= endIndex; i++)
            {
                ...
                if (fld.visibility)
                {
                    ...
                    string ddetails = String.Empty;
                    if (fld.tooltip != null && fld.tooltip != "")
                        ddetails = "<span class=\"material-icons material-icons-style align-middle material-icons-3 cursor-pointer\" title=\"Display details\">info</span>";
                    if (name.StartsWith("axp_recid"))
                    {
                        fieldHtml.Append("<div class=\"gridElement d-none form-group\" id=\"dvGrid" + fld.name.Replace(" ", "") + "\"><div class=\"fldhdn" + i + "\"><INPUT id=\"" + name + "\" type=\"hidden\" value=\"0\" name=\"" + name + "\" value=\"" + fld.Value + "\" /></div></div>");
                        if (isGrid)
