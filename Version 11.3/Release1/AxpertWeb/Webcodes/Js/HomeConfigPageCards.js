        ...
        this.html = {
			...
			<div class="mt-3 widgetWrapper htmlDomWrapper col-lg-3 col-md-3 col-sm-12 col-xs-3" id="HP_cards_list" data-cardname="{{caption}}">
                    <div class="Home-cards-list" style="background:{{colorcode}}">
                        ...
                        <span id="attendancetittle" class="Hp-card-title text-truncate" style="cursor:pointer" title="{{caption}}" onclick="navigateFromCard('{{caption}}','{{stransid}}')">{{caption}}</span><p>{{carddesc}}</p>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column let executedOnce = false;menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-primary fw-bold py-4 fs-6 w-300px " id="rowcount-{{rowCount}}" data-cardname="{{caption}}" data-rowcount="{{id}}" 
