<%@ Page Language="VB" AutoEventWireup="false" CodeFile="useraccess.aspx.vb" Inherits="pvtpages_useraccess" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../Js/useraccess.min.js?v=14"></script>
...
<body id="UserAccess_Content" class="Family btextDir-<%=direction%>" dir="<%=direction%>">
    <form id="form1" runat="server">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <ul class="nav nav-tabs nav-pills border-0 me-5 mb-3 mb-md-0 fs-6" role="tablist">
                            ...
                            <li id="liTransactionControl" class="nav-item w-50 me-0 mb-md-2" role="presentation">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="TransactionControl" role="tabpanel">
                                <div class="container">
        ...
        <div class="d-flex gap-3 float-end dialog-footer">
            <asp:Button runat="server" ID="save" Text="Save" CssClass="btn btn-primary btn-sm" />
