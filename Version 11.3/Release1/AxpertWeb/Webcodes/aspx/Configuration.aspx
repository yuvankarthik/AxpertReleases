...
<head runat="server">
    ...
    <script src="../Js/common.min.js?v=137" type="text/javascript"></script>
    <script>
    ...
    <form id="form1" runat="server">
        ...
        <div class="maincontainer">
            ...
            <div class="tab-content scrolldiv" id="nav-tabContent">
                <%--<div class ="card card-xl-stretch mb-1 mb-xl-2 border border-gray-300 rounded-0">--%>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="optOptBcrum" id="optBcrum" type="checkbox" />
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid  col-md-6">
                                                    ...
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="optCards" id="enableCardsText" type="checkbox" />
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="optCPWD" id="enablelblcpwdText" type="checkbox" />
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="optSessExt" id="enablelblsessText" type="checkbox" />
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="allowTimezone" id="allowTimezone" type="checkbox" />
                                                ...
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    <span class="setTitle">
                                                        <asp:Label ID="lblotpauth" CssClass="form-check-label form-label col-form-label pb-1 fw-boldest ms-0" runat="server" meta:resourcekey="lblotpauth" for="enable">OTP Authentication</asp:Label></span>
                                                    <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input class="form-check-input ms-3 w-45px h-25px" name="optSessExt" id="enablelblotpauth" type="checkbox" />
                                ...
                                <div id="collapseTwo" class="card-body" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <%--  <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                ...
                                                <a href="javascript:void(0)" class="swtchDummyAnchr form-check form-switch  form-check-solid ms-auto m-0 ps-0 py-4">
                                                    <input class="form-check-input ms-3 w-45px h-25px" id="enableDevInstance" type="checkbox" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="dvUserLeveLangs">
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0);" class="form-check form-switch form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input type="checkbox" class="form-check-input ms-3 w-45px h-25px" name="optUserLang" id="optUserLang" />
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div id="dvLangs">
                                                <div class="form-group form-switch form-check form-check-custom form-check-solid col-md-6">
                                                    ...
                                                    <a href="javascript:void(0);" class="form-check form-switch form-check-solid ms-auto m-0 ps-0 py-4">
                                                        <input type="checkbox" class="form-check-input ms-3 w-45px h-25px" name="optLang" value="english" />
                                                    </a>
                                                </div>
