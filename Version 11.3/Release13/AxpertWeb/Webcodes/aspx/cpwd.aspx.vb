...
Partial Class cpwd
    ...
    Public CpSecondMsg As String = "Your password is expired. You need to change the password."
    Public CpThirdMsg As String = "Your password has been reset. You need to change your password."
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Request.QueryString("remark") <> Nothing) Then
            ...
            End If
            If (remark <> Nothing And remark = "2" And Session("cpwdErr") = Nothing And hdncheckMsg.Value <> "true") Then
            ...
            End If
            If (remark <> Nothing And remark = "3" And Session("cpwdErr") = Nothing And hdncheckMsg.Value <> "true") Then
        ...
        Else
            ...
            If (Session("IsPwdAlphaNumeric") <> Nothing) Then
                ...
                End If
            End If
            hdnalphanumeric.Value = isPwdAlphaNumeric
