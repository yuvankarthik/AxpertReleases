...
<head runat="server">
    ...
    <script type="text/javascript" src="../Js/tstruct.min.js?v=608"></script>
    <script type="text/javascript" src="../Js/helper.min.js?v=167"></script>
    <script type="text/javascript" src="../Js/jsclient.min.js?v=111"></script>
...
<body onload="ChangeDir('<%=direction%>');">
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                <asp:ScriptReference Path="../Js/tstruct.min.js?v=608" />
            </Scripts>
            <Services>
    ...
    <script src="../Js/common.min.js?v=145"></script>
</body>
</html>
