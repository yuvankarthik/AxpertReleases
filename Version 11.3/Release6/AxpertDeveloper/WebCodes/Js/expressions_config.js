var expression_config = {
    "function": {
        ...
        "AxDcCollapse": {
            "selectText": "AxDcCollapse(DCName:String)"
        },
        "AxDcExpand": {
            "selectText": "AxDcExpand(DCName:String)"
        },
        "StringPOS": {
        ...
        "AxNoMask": {
            "selectText": "AxNoMask(FieldName:String)"
        },
        "ClearForm": {
            "selectText": "ClearForm(Transid,Params:String)"
        },
        "SetToRedis": {
...
var expression_FormControl_config = {
    "function": {
        "Abs": {
            "selectText": "Abs(Num:Numeric)"
        },
        ...
        "FormatAccAmount": {
            "selectText": "FormatAccAmount(Value,DecLen:numeric, withComma, MillionRep, ALIE, Rep :String)"
        },
        "LeftPad": {
            "selectText": "LeftPad(S: String; MaxLength: integer; c: Char)"
        },
