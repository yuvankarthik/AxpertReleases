...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../Js/process.min.js?v=203"></script>
    ...
    <script src="../Js/tstructvars.min.js?v=57" type="text/javascript"></script>
    <script type="text/javascript" src="../Js/md5.min.js"></script>
    <script type="text/javascript" src="../Js/adjustwindow.min.js?v=1"></script>
    <script type="text/javascript" src="../Js/tstruct.min.js?v=390"></script>
    ...
    <script src="../Js/main-tstruct.min.js?v=237" type="text/javascript"></script>
