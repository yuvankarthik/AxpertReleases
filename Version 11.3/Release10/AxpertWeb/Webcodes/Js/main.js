    ...
    if (doPageUnload != "false") {
        try {
            ...
            if (!localSessionVal || localSessionVal == 0) {
                ...
                if (isDuplicateTab == "true" && isMulDuplicateTab == "false") {
                ...
                } else if (isDuplicateTab == "true" && isMulDuplicateTab == "true") {
        ...
        if (src == "loadhomepage") {
            if (typeof isHomeConfigPage != "undefined" && isHomeConfigPage == "true" && $("#hdHomeUrl").val() == "") {
                ...
                if ($.axpertUI && $.axpertUI.cardsPage && $.axpertUI.cardsPage.options.setCards && typeof cardsData != "undefined" && cardsData.value != "[]") {
                    ...
                    document.querySelector(".HomePageCards")?.classList.add('col-md-6');
                ...
                src = $("#hdHomeUrl").val();
                if (isDuplicateTab == "true" && src != "" && src.indexOf("&isDupTab=") == -1)
                    src += "&isDupTab=" + isDuplicateTab;
            } else {
                if (isDuplicateTab == "true" && $("#hdHomeUrl").val() != "" && $("#hdHomeUrl").val().indexOf("&isDupTab=") == -1)
