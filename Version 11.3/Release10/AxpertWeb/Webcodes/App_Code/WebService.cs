...
namespace ASB
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        [WebMethod(EnableSession = true)]
        public string ExportARMPushToQueue(string iviewName, string iviewParams)
        {
            string response = string.Empty;
            string DATA = string.Empty;
            string URL = String.Empty;
            ...
            DATA = "{\"getreport\":{\"trace\":\"true\",\"metadata\":\"true\",\"pageno\":\"1\",\"pagesize\":\"0\",\"sqlpagination\":\"false\",\"params\":" + iviewParamsJson + ",\"project\":\"" + HttpContext.Current.Session["project"].ToString() + "\",\"name\":\"" + iviewName + "\",\"token\":\"d152232e23ff6523b8104196ff1b6015\",\"seed\":\"211269\",\"userauthkey\":\"" + Session["username"].ToString() + "\",\"arm_url\":\"" + HttpContext.Current.Session["ARM_URL"].ToString() + "\",\"ARMScriptURL\":\"" + ArmScriptURL + "\",\"axConfigFilePath\":\"" + axConfigFilePath + "\"}}";
