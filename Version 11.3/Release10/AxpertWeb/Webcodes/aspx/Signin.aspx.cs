...
public partial class Signin : System.Web.UI.Page
{
    ...
    private void SecurityCrossScripting(string _isMobDevice, string _hybridGUID, string _hybridDeviceId, string _hybridDefaultPage, string _hdnBwsrid)
    {
        try
        {
            if (Util.Util.CheckCrossScriptingInString(_isMobDevice) || Util.Util.CheckCrossScriptingInString(_hybridGUID) || Util.Util.CheckCrossScriptingInString(Request.Form["_hybridDeviceId"]) || Util.Util.CheckCrossScriptingInString(Request.Form["_hybridDefaultPage"]) || Util.Util.CheckCrossScriptingInString(Request.Form["_hdnBwsrid"]))
            {
                try
                {
                    Response.Redirect(Constants.LOGINPAGE, true);
    ...
    [WebMethod]
    public static string chkOtp(string stsotpauth, string proj, string username)
    {
    ...
    [WebMethod]
    public static string Getlang(string proj, string username)
    {
        string res = string.Empty;
        Util.Util utils = new Util.Util();
        utils.GetAxApps(proj);
