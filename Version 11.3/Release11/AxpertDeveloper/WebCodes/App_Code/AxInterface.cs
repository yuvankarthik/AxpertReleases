...
namespace AxInterface
{
    ...
    public class AxpertInterSaveData
    {
        ...
        public string GenerateXMLStrucuture()
        {
            ...
            string properties = "<Transaction axpapp=\"" + HttpContext.Current.Session["webProj"].ToString() + "\" afiles=\"\" trace=\"" + errorLog + "\" sessionid=\"" + HttpContext.Current.Session["nsessionid"].ToString() + "\" appsessionkey='" + HttpContext.Current.Session["AppSessionKey"].ToString() + "' username='" + HttpContext.Current.Session["username"].ToString() + "'>{0}" + HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</Transaction>";
    ...
    public class AxpertInterGetCustomSql
    {
        ...
        public JObject GetCustomSqlData()
        {
            ...
            try
            {
                ...
                inputXml += HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</sqlresultset>";
    ...
    public class AxpertInterGetWidget
    {
        ...
        public string GetWidgetData()
        {
            ...
            iXML += HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</sqlresultset>";
            ASBExt.WebServiceExt objWebServiceExt = new ASBExt.WebServiceExt();
    ...
    public class AxpertInterGetIview
    {
        ...
        public string GetIviewData()
        {
            ...
            iXml += HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</root> ";
            ASBExt.WebServiceExt objWebServiceExt = new ASBExt.WebServiceExt();
    ...
    public class AxpertInterLoadData
    {
        ...
        public string LoadData()
        {
            string json = string.Empty;
            string InputXml = "";
            InputXml = InputXml + "<root imagefromdb='false' axpapp='" + HttpContext.Current.Session["webProj"].ToString() + "' sessionid='" + HttpContext.Current.Session.SessionID + "' appsessionkey='" + HttpContext.Current.Session["AppSessionKey"].ToString() + "' username='" + HttpContext.Current.Session["username"].ToString() + "' transid='" + transId + "' recordid='" + recId + "' dcname='' trace=''>";
            InputXml += HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString();
            InputXml += "</root>";
            ASBExt.WebServiceExt objWebServiceExt = new ASBExt.WebServiceExt();
    ...
    public class AxpertInterAction
    {
        ...
        public string Action()
        {
            ...
            InputXml += HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString();
            InputXml += "</root>";
            ASBExt.WebServiceExt objWebServiceExt = new ASBExt.WebServiceExt();
        ...
        public AxpertInterAction(string ActionName, string ActionType, string SName, DataSet ds, string ivSelectedRows)
        {
    ...
    public class AxpertInterDeleteRecord
    {
        ...
        public string GenerateDeleteInputXML()
        {
            ...
            string properties = "<Transaction axpapp='" + HttpContext.Current.Session["webProj"].ToString() + "' trace='" + errorLog + "' sessionid='" + HttpContext.Current.Session["nsessionid"].ToString() + "' appsessionkey='" + HttpContext.Current.Session["AppSessionKey"].ToString() + "' username='" + HttpContext.Current.Session["username"].ToString() + "' transid='" + transId + "' recordid='" + recordId + "' action='delete' allowCancel='true' >" + HttpContext.Current.Session["axApps"].ToString() + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</Transaction>";
    ...
    public class AxpertInterGetRecord
    {
        ...
        public string GeneratGetRecordInputXML()
        {
            ...
            string xml = "<root axpapp='" + HttpContext.Current.Session["webProj"].ToString() + "' sessionid='" + HttpContext.Current.Session["nsessionid"].ToString() + "' trace='" + errorLog + "' transid='" + transId + "' appsessionkey='" + HttpContext.Current.Session["AppSessionKey"].ToString() + "' username='" + HttpContext.Current.Session["username"].ToString() + "'><values>";
            ...
            xml = xml + HttpContext.Current.Session["webAxApps"].ToString() + HttpContext.Current.Application["axProps"].ToString() + HttpContext.Current.Session["axGlobalVars"].ToString() + HttpContext.Current.Session["axUserVars"].ToString() + "</root>";
