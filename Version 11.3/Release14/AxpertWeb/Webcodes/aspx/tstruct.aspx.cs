                                    ...
                                    if (strParams != string.Empty)
                                    {
                                        ...
                                        foreach (string _ptname in _arrParams)
                                        {
                                            if (_ptname != "")
                                            {
                                                ...
                                                returnString.Append("<" + _thisParamName.ToString() + ">" + CheckSpecialChars(_thisParamVal.ToString()) + "</" + _thisParamName.ToString() + ">");
                                                paramNames.Add(_thisParamName);
                                                clientParamValues.Add(CheckSpecialChars(_thisParamVal.ToString()));
                                            }
                                        }
                                    }
                                }
