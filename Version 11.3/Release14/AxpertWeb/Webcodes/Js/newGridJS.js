                    ...
                    if (typeOfField != undefined && typeOfField != "undefined") {
                        ...
                        if (typeOfField == "hidden") {
                            ...
                            if (fldDType == "Password") {
                                ...
                                editorHtml += '<input id="' + idOFtheField + '" name="' + idOFtheField + '" title="" value="' + valueOfField + '" maxlength="' + maxlength + '" class="focus-input ' + classes + '" style="' + inlineStyle + '" type="password">';
