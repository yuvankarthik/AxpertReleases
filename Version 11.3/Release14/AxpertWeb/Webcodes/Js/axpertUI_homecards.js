        ...
        options = {
                                    ...
                                    if (!childObj.icon) {
                                        ...
                                        if (childObj.target != undefined && childObj.target != "") {
                                            if (childObj.target.indexOf("tstruct.aspx") > -1  || childObj.target.indexOf("EntityForm.aspx") > -1) {
                                                iconText = "assignment";
                                            } else if (childObj.target.indexOf("iview.aspx") > -1 || childObj.target.indexOf("iviewInteractive.aspx") > -1 || childObj.target.indexOf("Entity.aspx") > -1) {
                                                if (!isListView) {
                                                    iconText = "view_list";
                                                } else {
            ...
            cardsPage: {
                ...
                html: {
                    ...
                    `,
                    kpi: `
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 mt-3 widgetWrapper kpiWrapper">
                      <div class="card rounded-1 shadow-sm h-100">
                          ...
                          <div class="card-content-wrapper d-flex align-items-center">
                              <div style="background:transparent" class="card-header border-0 flex-grow-1">
                                  <div class="card-title d-flex align-items-center">
                                      ...
                                      <div class="symbol symbol-35px me-2 mainIcon">
                                          <div class="symbol-label">
                                              <span class="material-icons material-icons-style iconContent" style="display: none;">
                              ...
                              <!-- Card Body Content -->
                              <div class="card-body heightControl flex-grow-1">
                                  <div style="float:right;" class="fw-bolder fs-2">
                                      <div>
                                          <bodyContent class="fs-2qx---">No Data Found</bodyContent>
                                      </div>
                                  </div>
                              </div>
                          </div>
            ...
            _addCardIcon(cardElement, card) {
                ...
                if (icon) {
                    if (icon.toLowerCase().startsWith("http://") || icon.toLowerCase().startsWith("https://")) {
                        ...
                        cardElement.find(".symbol .iconContent").text(icon).show();
                        iconDiv.addClass("iconAdded");
                        imgIconElemParent.addClass("d-none");
                    }
                } else {
                    cardElement.find(".iconContent").addClass("d-none");
                    imgIconElemParent.addClass("d-none");
                    ...
                    cardElement.find(".symbol .symbol-label").append(fallbackIconDiv);
                }
            }
