...
function setGlobalTheme() {
    try {
        if (typeof axThemeStyleFolder != "undefined" && axThemeStyleFolder != "") {
            ...
            var url = "../" + axThemeStyleFolder + "/axGlobalThemeStyle.css";
            $.ajax({
                url,
                type: 'HEAD',
                success() {
                    ...
                    localStorage["axGlobalThemeStyle-" + appUrl] = tStamp;
                    localStorage["axThemeFldr-" + appUrl] = axThemeStyleFolder;
                },
                error() {
                    themeLink.replaceWith("<link id=\"axGlobalThemeStyle\" data-themfld=\"" + axThemeStyleFolder + "\" href=\"\" rel=\"stylesheet\" />");
                    localStorage["axGlobalThemeStyle-" + appUrl] = false
                    localStorage.removeItem("axThemeFldr-" + appUrl);
                }
            });
        } else {
            //themeLink.replaceWith("<link id=\"axGlobalThemeStyle\" data-themfld=\"" + axThemeStyleFolder + "\" href=\"\" rel=\"stylesheet\" />");
