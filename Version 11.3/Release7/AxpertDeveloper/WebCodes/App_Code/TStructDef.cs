    ...
    public void Create(string xml)
    {
        ...
        foreach (XmlNode tstBaseDataNode in tstBaseDataNodes)
        {
            ...
            foreach (XmlNode tstChildDataNode in tstChildDataNodes)
            {
                ...
                {
                    if (tstChildDataNode.Attributes["dwbtb"] != null && tstChildDataNode.Attributes["dwbtb"].Value.ToString().ToLower() == "true" && (transId != "ad_cd" && transId != "axcad" && transId != "ad_cg" && transId != "ad_cs" && transId != "axrul" && transId != "ad_as"))
                    {
                        dwbToolbar = true;
