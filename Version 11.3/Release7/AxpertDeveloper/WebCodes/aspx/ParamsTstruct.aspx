...
<head id="Head1" runat="server">
    ...
    <link href="../Css/msgBoxLight.min.css?v=3" rel="stylesheet" type="text/css" />
    ...
    <link href="../Css/workflowNew.min.css?v=7" rel="stylesheet" />
    <!--Links for Tab control -->
    <script type="text/javascript" src="../Js/process.min.js?v=204"></script>
    ...
    <script src="../Js/thirdparty/jquery-ui/jquery-ui-autoCom/jquery-ui-autoCom.min.js?v=2"></script>
    ...
    <script src="../Js/tstructvars.min.js?v=58" type="text/javascript"></script>
    <script type="text/javascript" src="../Js/md5.min.js"></script>
    <script type="text/javascript" src="../Js/adjustwindow.min.js?v=1"></script>
    <script type="text/javascript" src="../Js/tstruct.min.js?v=391"></script>
    ...
    <script src="../Js/main-tstruct.min.js?v=238" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="../Js/newGridJS.min.js?v=154"></script>
    ...
    <script src="../Js/autoComplete.min.js?v=68" type="text/javascript"></script>
            ...
            <div id="dvToolbar" runat="server">
                <ul>
                   ...
                   <%-- <li title="Add field">
                    ...
                    <li title="HTML" id="btnTstHTML" class="hide" runat="server">
