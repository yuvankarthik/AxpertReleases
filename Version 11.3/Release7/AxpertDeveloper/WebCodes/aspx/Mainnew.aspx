...
<head id="Head1" runat="server">
    ...
    <link href="../newPopups/axpertPopup.min.css?v=22" rel="stylesheet" />
    ...
    <script src="../Js/helper.min.js?v=115"></script>
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=88"></script>
    <script src="../Js/process.min.js?v=204"></script>
    ...
    <script type="text/javascript" src="../js/main.min.js?v=219"></script>
</head>

<body id="mainNewPageBody" onload="ChangeDir('<');"
    class="btextDir-<%=direction%> hold-transition homePageBody skin-blue sidebar-mini" onunload="ClosePopUps();">
    ...
    <form id="form1" runat="server" onclick="javascript:HideHelp();">
        ...
        <div id="myPopover" class="hide" runat="server">
        </div>
        ...
        <div>
            ...
            <div runat="server" class="info hide" id="dvMessage">
                        ...
                        <nav class="navbar navbar-static-top">
                                ...
                                <div class="logo-main">
                                    <a class="brand" href="javascript:void(0)" tabindex="1" title="<%=appName %>"
                                        ...
                                        <img class="left" src="../images/Custom/logo.png?v=<%=ver %>"
                                            style="width: 48px;" alt="logo" onclick="loadHome();" />
                                        <%}
                                            else %>
                                        ...
                                        <span
                                            ...
                                            onclick="loadHome();" class="titlename">
                            ...
                            <div class="header-mid">
                                ...
                                <div id="nav-searchbox" class="globalSrch">
                                    ...
                                    <i id="gloSrchSpin" class="icon-arrows-rotate rorate-icon hide"></i>
                            ...
                            <div class="header-right">
                                ...
                                <a class="cloudbrand" href="javascript:void(0)" tabindex="1" title="<%=appName %>">
                                    <span class="cloudtitle" onclick="loadHome();" class="titlename">
                                        <%=appName %>
                                    </span>
                    ...
                    <section class="mybreadcram">
                        <div class="row">
                            ...
                            <div class="button-splitter">
                                <%if (Session["MobileView"] != null && Session["MobileView"].ToString() == "False")
                                    {%>
                                <div class="split-btn hide" onclick="assocateIframe();splitvertical();" title="Vertical Split" style="transform: rotate(90deg);"><i class="fa fa-sort"></i></div>
                                <div class="split-btn-vertical hide" onclick="assocateIframe();splithorizantal();" title="Horizontal Split"><i class="fa fa-sort"></i></div>
    ...
    <%if (templateText == String.Empty)
        {%>
    <link href="../AssetsNew/css/style.min.css?v=2" rel="stylesheet" />
    <%} %>
