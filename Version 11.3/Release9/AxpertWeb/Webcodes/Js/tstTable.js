                        ...
                        for (var i = 0; i < colCount; i++) {
                            ...
                            if (callParentNew("FMoe")[sourFldInd] == "Select") {
                                ...
                                if (callParentNew("FDataType")[sourFldInd] == "Numeric") {
                                    ...
                                    tdRow += "<td class=\"input-group-sm " + tfhide + "\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" class=\"tem Family form-control flatpickr-input fldtableinput\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\">";
                    ...
                    for (var i = 0; i < colCount; i++) {
                        ...
                        if (callParentNew("FMoe")[sourFldInd] == "Select") {
                            ...
                            if (callParentNew("FDataType")[sourFldInd] == "Numeric") {
                                ...
                                formDiv += "<div class=\"input-group\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" class=\"tem Family form-control flatpickr-input fldtableinput\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + 0) + "\" value=\"" + colValue + "\">";
