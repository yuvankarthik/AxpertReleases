    ...
    public class Util
    {
        ...
        public void DeleteTstIvObject(string TstIvKey = "")
        {
            try
            {
                ...
                {
                    if (HttpContext.Current.Session["tstivobjkey-duptab"] != null && HttpContext.Current.Session["tstivobjkey-duptab"].ToString() != "")
                    {
                        string tstivobjkey = HttpContext.Current.Session["tstivobjkey-duptab"].ToString();
                        ...
                        if (TstIvKey != "" && item.Count > 0)//To remove from the TstIvKey to next keys
                        {
                            ...
                            HttpContext.Current.Session["tstivobjkey-duptab"] = tstivobjkey;
                        }
                        else//To remove all the keys 
                        {
                            ...
                            HttpContext.Current.Session.Remove("tstivobjkey-duptab");
                        }
                    }
                }
